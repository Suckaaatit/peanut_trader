...
import { LogOut, Phone, RefreshCw, TrendingUp, TrendingDown, ExternalLink } from 'lucide-react';
          ...
          <div className="flex space-x-4 overflow-x-auto pb-2 scrollbar-hide">
            {promotions.map(p => (
              <a
                ...
                className="min-w-[260px] bg-gradient-to-br from-orange-500 to-rose-500 p-4 rounded-xl text-white shadow-md block hover:shadow-lg transition-shadow"
              >
